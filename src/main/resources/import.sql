...
CREATE TABLE products (id integer NOT NULL PRIMARY KEY, cost integer, title varchar(255));

CREATE TABLE buyers (id integer NOT NULL PRIMARY KEY, name varchar(255));
...
INSERT INTO products (id, title, cost) VALUES (1, 'bread', 30), (2, 'milk', 30), (3, 'egg', 80), (4, 'butter', 80), (5, 'chicken', 100), (6, 'meat', 300);
